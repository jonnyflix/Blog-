...
Furthermore, you have the option to only select parts of the dataset and consequently only save these parts on your desktop. For this project we just wanted the data from the 1980s Phillies:
```{r}
query<-"SELECT *
FROM Batting
